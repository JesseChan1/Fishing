...
public class BottomLevel extends Componet{
	...
	public void updateNumIndex(){
		String currentPart = GamePartManager.getManager().getCurrentPart().getPartName();
		num_index = new int[currentPart.length()];
		int index = 0;
		for(char n:currentPart.toCharArray()){
